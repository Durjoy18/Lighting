...
void gate(unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether);
...
//void drawtablesofa(unsigned int& cubeVAO, Shader& ourShader, float tx, float ty, float tz);
    ...
    while (!glfwWindowShouldClose(window))
    {
       ...
       // pointlight4.setUpPointLight(lightingShader);
        ...
        //rightwall(cubeVAO, lightingShader, model);
         ...
         gate(cubeVAO, lightingShader,tmp);
...
void gate(unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether)
{
    ...
    scale = glm::scale(model, glm::vec3(0.5,-8.0,0.5f));
...
void bed(unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 alTogether)
{
    ...
    translate = glm::translate(model, glm::vec3(-2.5, 20.0, -2.5));
    model = alTogether * scale * translate;
    ...
    translateMatrix = glm::translate(model, glm::vec3(1.0, 4.0, -2.0));
    scaleMatrix = glm::scale(model, glm::vec3(2.5, 0.2, 1.5));
    model = alTogether * scaleMatrix * translateMatrix;
    drawCube(cubeVAO, lightingShader, model, 0.345, 0.171, 0.475);

    translateMatrix = glm::translate(model, glm::vec3(-2.0f,  0.0f,3.0f));
    scaleMatrix = glm::scale(identityMatrix, glm::vec3(0.002f, -2.0f, 0.2f));
    model = alTogether * translateMatrix* scaleMatrix;
    drawCube(cubeVAO, lightingShader, model, 0.345, 0.171, 0.475);

    */

    //ourShader.setVec4("color", glm::vec4(0.769f, 0.682f, 0.176f, 0.612f));
